    ...
    <div className="flex flex-col gap-5 p-5">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 gap-2">
          <Link
            href="/fridge"
            className="flex items-center gap-2 rounded-lg bg-green-50 p-3 text-sm font-medium text-green-700 transition-colors hover:bg-green-100"
          >
          ...
          <Link
            href="/recipes"
            className="flex items-center gap-2 rounded-lg bg-orange-50 p-3 text-sm font-medium text-orange-700 transition-colors hover:bg-orange-100"
          >
